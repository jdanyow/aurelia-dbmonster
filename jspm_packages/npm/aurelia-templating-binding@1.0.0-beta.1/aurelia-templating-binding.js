define(['exports', 'aurelia-logging', 'aurelia-binding', 'aurelia-templating'], function (exports, _aureliaLogging, _aureliaBinding, _aureliaTemplating) {
  ...
  var InterpolationBinding = (function () {
    ...
    InterpolationBinding.prototype.call = function call() {
      for (var i = 1, ii = binding.parts.length; i < ii; i += 2) {
    ...
    InterpolationBinding.prototype.bind = function bind(source) {
      ...
      for (var i = 1, ii = parts.length; i < ii; i += 2) {
        var _binding = new ChildInterpolationBinding(this, this.observerLocator, parts[i], this.mode, this.lookupFunctions);
        _binding.bind(source);
        this['childBinding' + i] = _binding;
      }
